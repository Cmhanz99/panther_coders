...
@section('content')
    ...
    <section class="nearby-properties">
        <div class="container">
            ...
            <div class="map-container">
                ...
                <div class="map-placeholder">
                    <div class="map-overlay">
                        ...
                        <!-- Sample popup -->
                        <div class="map-popup">
                            <img src="{{ asset('images/apartment1.jpg') }}" alt="Property Preview">
                            <h4>Sugbo Apartment</h4>
                            <p>$450,000 | 2 bed, 2 bath</p>
                            <p class="distance-text">0.3 miles away</p>
